...
$(BUILD_DIR)/docker/bin/%: $(PROJECT_FILES)
	...
	@$(DRUN) \
		...
		$(BASE_DOCKER_NS)/blockchain-baseimage:$(BASE_DOCKER_TAG) \
...
$(BUILD_DIR)/image/tools/$(DUMMY): $(BUILD_DIR)/image/tools/Dockerfile
	...
	$(DBUILD) -t $(DOCKER_NS)/blockchain-$(TARGET) -f $(@D)/Dockerfile .
	docker tag $(DOCKER_NS)/blockchain-$(TARGET) $(DOCKER_NS)/blockchain-$(TARGET):$(DOCKER_TAG)
	docker tag $(DOCKER_NS)/blockchain-$(TARGET) $(DOCKER_NS)/blockchain-$(TARGET):$(ARCH)-latest
	@touch $@
