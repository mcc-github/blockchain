...
func TestMetricsByStatsdReporter(t *testing.T) {
	...
	expected := []string{
		`mcc-github_blockchain.peer.success_total.component-committer.env-test:1|c`,
		`mcc-github_blockchain.peer.channel_total.component-committer.env-test:4|g`,
	}
...
func TestMetricsByPrometheusReporter(t *testing.T) {
	...
	expected := []string{
		`# HELP mcc-github_blockchain_peer_channel_total mcc-github_blockchain_peer_channel_total gauge`,
		`# TYPE mcc-github_blockchain_peer_channel_total gauge`,
		`mcc-github_blockchain_peer_channel_total{component="committer",env="test"} 4`,
		`# HELP mcc-github_blockchain_peer_success_total mcc-github_blockchain_peer_success_total counter`,
		`# TYPE mcc-github_blockchain_peer_success_total counter`,
		`mcc-github_blockchain_peer_success_total{component="committer",env="test"} 1`,
		``,
	}
