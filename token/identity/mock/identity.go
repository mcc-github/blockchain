...
import (
	...
	mspblockchain "github.com/mcc-github/blockchain/msp"
...
type Identity struct {
	...
	GetIdentifierStub        func() *mspblockchain.IdentityIdentifier
	getIdentifierMutex       sync.RWMutex
	getIdentifierArgsForCall []struct{}
	getIdentifierReturns     struct {
		result1 *mspblockchain.IdentityIdentifier
	}
...
func (fake *Identity) GetIdentifier() *mspblockchain.IdentityIdentifier {
...
func (fake *Identity) GetIdentifierReturns(result1 *mspblockchain.IdentityIdentifier) {
...
func (fake *Identity) GetIdentifierReturnsOnCall(i int, result1 *mspblockchain.IdentityIdentifier) {
	fake.GetIdentifierStub = nil
...
func (fake *Identity) GetOrganizationalUnits() []*mspblockchain.OUIdentifier {
...
func (fake *Identity) GetOrganizationalUnitsReturns(result1 []*mspblockchain.OUIdentifier) {
...
func (fake *Identity) GetOrganizationalUnitsReturnsOnCall(i int, result1 []*mspblockchain.OUIdentifier) {
	fake.GetOrganizationalUnitsStub = nil
