...
gotool.protoc-gen-go:
	...
	@cp -R $(GOPATH)/src/github.com/mcc-github/blockchain/vendor/github.com/golang/protobuf/* $(GOTOOLS_GOPATH)/src/github.com/golang/protobuf
...
gotool.ginkgo:
	...
	@cp -R $(GOPATH)/src/github.com/mcc-github/blockchain/vendor/github.com/onsi/ginkgo/* $(GOTOOLS_GOPATH)/src/github.com/onsi/ginkgo
