...
metrics_template="${blockchain_dir}/docs/source/metrics_reference.rst.tmpl"
metrics_doc="${blockchain_dir}/docs/source/metrics_reference.rst"

gendoc_command="go run github.com/mcc-github/blockchain/common/metrics/cmd/gendoc -template ${metrics_template}"
