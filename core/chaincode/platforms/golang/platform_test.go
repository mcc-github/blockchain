...
func Test_DeploymentPayload(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "github.com/mcc-github/blockchain/examples/chaincode/go/example02/cmd",
		},
	}
...
func Test_DeploymentPayloadWithStateDBArtifacts(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "github.com/mcc-github/blockchain/examples/chaincode/go/marbles02",
		},
	}
...
func TestValidateSpec(t *testing.T) {
	...
	var tests = []struct {
		...
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "http://github.com/mcc-github/blockchain/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "https://github.com/mcc-github/blockchain/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/mcc-github/blockchain/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/mcc-github/blockchain/bad/chaincode/go/map"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: ":github.com/mcc-github/blockchain/examples/chaincode/go/map"}}, succ: false},
	}
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{gopath: defaultGopath, spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/mcc-github/blockchain/examples/chaincode/go/map"}}, succ: true},
		{gopath: defaultGopath, spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/mcc-github/blockchain/examples/bad/go/map"}}, succ: false},
