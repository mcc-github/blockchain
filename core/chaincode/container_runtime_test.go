...
func TestContainerRuntimeLaunchConfigFiles(t *testing.T) {
	...
	assert.Equal(t, map[string][]byte{
		"/etc/mcc-github/blockchain/client.crt": []byte("certificate"),
		"/etc/mcc-github/blockchain/client.key": []byte("key"),
		"/etc/mcc-github/blockchain/peer.crt":   []byte("peer-ca-cert"),
	}, lc.Files)
}
