...
func TestInvalidTXsForUpgradeCC(t *testing.T) {
	txsChaincodeNames := map[int]*sysccprovider.ChaincodeInstance{
		0: {ChannelID: "chain0", ChaincodeName: "cc0", ChaincodeVersion: "v0"}, 
		1: {ChannelID: "chain1", ChaincodeName: "cc0", ChaincodeVersion: "v0"}, 
		2: {ChannelID: "chain1", ChaincodeName: "lscc", ChaincodeVersion: ""},  
		3: {ChannelID: "chain1", ChaincodeName: "cc0", ChaincodeVersion: "v0"}, 
		4: {ChannelID: "chain1", ChaincodeName: "cc0", ChaincodeVersion: "v1"}, 
		5: {ChannelID: "chain1", ChaincodeName: "cc1", ChaincodeVersion: "v0"}, 
		6: {ChannelID: "chain1", ChaincodeName: "lscc", ChaincodeVersion: ""},  
		7: {ChannelID: "chain1", ChaincodeName: "lscc", ChaincodeVersion: ""},  
	}
