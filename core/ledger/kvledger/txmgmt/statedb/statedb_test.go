...
func TestMergeUpdateBatch(t *testing.T) {
	...
	batch2.Put("ns1", "key1", []byte("batch2_value1"), version.NewHeight(4, 4)) 
	batch2.Delete("ns1", "key2", version.NewHeight(5, 5))                       
	batch2.Put("ns1", "key4", []byte("batch2_value4"), version.NewHeight(6, 6)) 
	batch2.Delete("ns1", "key5", version.NewHeight(7, 7))                       
	batch2.Put("ns2", "key6", []byte("batch2_value6"), version.NewHeight(8, 8)) 
