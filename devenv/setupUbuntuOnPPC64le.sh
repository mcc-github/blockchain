...
#
# See https://github.com/mcc-github/blockchain/blob/master/docs/dev-setup/install.md#building-outside-of-vagrant-
#
...
#	mkdir -p $GOPATH/src/github.com/mcc-github
#	cd $GOPATH/src/github.com/mcc-github
#	git clone http://gerrit.mcc-github.org/r/blockchain
#	sudo ./blockchain/devenv/setupUbuntuOnPPC64el.sh
...
if [ ! -d "$GOPATH/src/github.com/mcc-github/blockchain" ]
then
    echo "Ensure blockchain code is under $GOPATH/src/github.com/mcc-github/blockchain"
    exit
fi
