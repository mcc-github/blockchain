...
# same for Vagrant.
# See https://github.com/mcc-github/blockchain/blob/master/docs/dev-setup/install.md
#
# To get started:
#       sudo su
#       yum install git
#       mkdir -p $HOME/git/src/github.com/mcc-github
#       cd $HOME/git/src/github.com/mcc-github
#       git clone http://gerrit.mcc-github.org/r/blockchain
#       source blockchain/devenv/setupRHELonZ.sh
#       make peer unit-test
...
if [ -n -d $HOME/git/src/github.com/mcc-github/blockchain ]
then
    echo "Script blockchain code is under $HOME/git/src/github.com/mcc-github/blockchain "
    exit
fi
...
# Build the actual mcc-github peer
