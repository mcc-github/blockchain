...
import (
	...
	pcomm "github.com/mcc-github/blockchain-protos-go/common"
	...
	capabilitymock "github.com/mcc-github/blockchain/gossip/privdata/mocks"
	"github.com/mcc-github/blockchain/gossip/protoext"
	"github.com/mcc-github/blockchain/gossip/state/mocks"
	gossiputil "github.com/mcc-github/blockchain/gossip/util"
	gutil "github.com/mcc-github/blockchain/gossip/util"
...
func TestTransferOfPrivateRWSet(t *testing.T) {
	...
	for seqNum, each := range data {
		coord1.On("GetPvtDataAndBlockByNum", seqNum).Return(each.block, each.pvtData, nil )
	}
