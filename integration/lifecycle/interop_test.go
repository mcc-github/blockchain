			...
			Describe("Chaincode-to-chaincode interoperability", func() {
				...
				BeforeEach(func() {
					...
					callerDefOld = nwo.Chaincode{
						Name:    "caller",
						Version: "0.0",
						Path:    "github.com/mcc-github/blockchain/integration/lifecycle/chaincode/caller/cmd",
						Ctor:    `{"Args":[""]}`,
						Policy:  ccEP,
					}
					calleeDefOld = nwo.Chaincode{
						Name:    "callee",
						Version: "0.0",
						Path:    "github.com/mcc-github/blockchain/integration/lifecycle/chaincode/callee/cmd",
						Ctor:    `{"Args":[""]}`,
						Policy:  ccEP,
					}
					callerDefNew = nwo.Chaincode{
