...
var _ bool = Describe("DiscoveryService", func() {
	...
	AfterEach(func() {
		...
		filters = map[string][]string{}
		filters["label"] = []string{"org.mcc-github.blockchain.chaincode.id.name=mytest"}
	...
	It("test discovery service capabilities", func() {
		...
		installCC.InstallChaincode("mytest", "1.0", "github.com/mcc-github/blockchain/integration/chaincode/simple/cmd")
