...
import (
	...
	"github.com/mcc-github/blockchain/integration/pvtdata/helpers"
	"github.com/mcc-github/blockchain/integration/pvtdata/runner"
	"github.com/mcc-github/blockchain/integration/pvtdata/world"
...
var _ = Describe("PrivateData-EndToEnd", func() {
	...
	Describe("collection config is modified", func() {
		BeforeEach(func() {
			...
			installChaincodeOnAllPeers(1, 3, d.Chaincode.Name, "2.0", "github.com/mcc-github/blockchain/integration/chaincode/marbles_private/cmd", testDir)
		})
		...
		It("verifies access to private data after an org is removed from collection config and then added back", func() {
			...
			installChaincodeOnAllPeers(1, 3, d.Chaincode.Name, "3.0",
				"github.com/mcc-github/blockchain/integration/chaincode/marbles_private/cmd", testDir)
	...
	Describe("network partition with respect of private data", func() {
		BeforeEach(func() {
			...
			installChaincodeOnAllPeers(1, 2, d.Chaincode.Name, "2.0", "github.com/mcc-github/blockchain/integration/chaincode/marbles_private/cmd", testDir)
		})
		...
		It("verifies private data not distributed when there is network partition", func() {
			...
			adminPeer.InstallChaincode("marblesp", "2.0", "github.com/mcc-github/blockchain/integration/chaincode/marbles_private/cmd")
...
func verifyAccess(ccname string, channel string, args string, peers []*runner.Peer, expected string) {
	for _, peer := range peers {
		...
		}, time.Minute).Should(gbytes.Say(expected)) 
	}
}
