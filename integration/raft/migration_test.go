...
import (
	...
	protosorderer "github.com/mcc-github/blockchain-protos-go/orderer"
	protosraft "github.com/mcc-github/blockchain-protos-go/orderer/etcdraft"
...
func prepareTransition(
	network *nwo.Network, peer *nwo.Peer, orderer *nwo.Orderer, channel string, 
	fromConsensusType string, fromMigState protosorderer.ConsensusType_State, 
	toConsensusType string, toConsensusMetadata []byte, toMigState protosorderer.ConsensusType_State, 
